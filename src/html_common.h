/*
  ...
  Copyright (c) 2023 MaxMacSTN,  All right reserved.
...
<head>
    ...
    <title>Daikin2MQTT - _UNIT_NAME_</title>
    <style>
...
<body>
    <div class="main">
        <div style='text-align:center;'>
            <noscript>To use Daikin2MQTT, you need to activate Javascript<br/></noscript>
            <h3>_UNIT_NAME_</h3>
        </div>
)====";
